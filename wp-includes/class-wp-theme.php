...
final class WP_Theme implements ArrayAccess {
	...
	/**
	 * Header data from the theme's style.scss file.
	 *
	 * @var array
	 */
	...
	/**
	 * Header data from the theme's style.scss file after being sanitized.
	 *
	 * @var array
	 */
	...
	/**
	 * Header name from the theme's style.scss after being translated.
	 *
	...
	public function __construct( $theme_dir, $theme_root, $_child = null ) {
		...
		$theme_file       = $this->stylesheet . '/style.scss';
		...
		if ( ! $this->template && ! ( $this->template = $this->headers['Template'] ) ) {
			...
			if ( ! file_exists( $this->theme_root . '/' . $this->stylesheet . '/index.php' ) ) {
				$error_message = sprintf(
					/* translators: 1: index.php, 2: link to documentation, 3: style.scss */
	...
	public function offsetGet( $offset ) {
		switch ( $offset ) {
			...
			case 'Stylesheet Files':
				return $this->get_files( 'scss', 0, false );
			case 'Template Dir':
				return $this->get_template_directory();
			case 'Stylesheet Dir':
				return $this->get_stylesheet_directory();
	 ...
	 * The 'Template' header is only good for what was written in the style.scss, while
